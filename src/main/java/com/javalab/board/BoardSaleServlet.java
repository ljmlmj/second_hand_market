...
@WebServlet("/boardSale")
public class BoardSaleServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	protected void doGet(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		System.out.println("boardSale doGet()");
		...
		boardList = boardDao.getBoardSaleList(boardvo);
		...
		RequestDispatcher dispatch = request.getRequestDispatcher("/board/boardSaleList.jsp");
