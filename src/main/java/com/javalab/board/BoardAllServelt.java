 ...
 */
@WebServlet("/boardAll")
public class BoardAllServelt extends HttpServlet {
	private static final long serialVersionUID = 1L;

	//private BoardDao boardDao = BoardDao.getInstance();

	public BoardAllServelt() {
		super();
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("boardAll doGet()");
		...
		RequestDispatcher dispatch = request.getRequestDispatcher("/board/boardAllList.jsp");
